...
from src.abstract_retrieval.UserQueryDataStore import UserQueryDataStore
from src.abstract_retrieval.AbstractRetriever import ScientificAbstract
from src.abstract_retrieval.AbstractRetriever import UserQueryRecord
...
class LocalJSONStore(UserQueryDataStore):
    ...
    def read_dataset(self, query_id: str) -> List[ScientificAbstract]:
        ...
        try:
            ...
            #print(f'The JSON file for this query: {query_id} was not found.')
    ...
    def save_dataset(self, abstracts_data: List[ScientificAbstract], user_query: str) -> str:
        ...
        try:
            ...
            #print(f"Data for query ID {query_id} saved successfully.")
            ...
            #print(f"Failed to save dataset for query ID {query_id}: {e}")
    ...
    def delete_dataset(self, query_id: str) -> None:
        ...
        if os.path.exists(path_to_data):
            ...
            #print(f"Directory '{path_to_data}' has been deleted.")
            ...
            #print(f"Directory '{path_to_data}' does not exist and cannot be deleted.")
